---
name: dilution-event-scoring
description: Use when assessing how dilutive a small-cap stock's situation is on a 0-100 scale. Integrates ATM activity, placement-agent tier, filing recency, cash runway, warrant attachment, and repeat-dilution history into a single decision-grade score with action thresholds.
license: MIT
---
